...
/**
 * This function loads and configures the 'Inter' font for use in a Next.js application.
 * It uses the `Inter` function from Next.js' font module to load the font files from Google Fonts.
 * The function also sets the CSS variable `--font-inter` to the loaded font,
